...
import chatapprmi.Client.ChatClient;
import chatapprmi.Common.Message;
import chatapprmi.Server.ChatServer;
...
public class ChatView extends javax.swing.JFrame {
    ...
    public void setClient(ChatClient cli){
        mode=1;
        client = cli;
    }
    public void setServer(ChatServer srv) {
        mode = 2;
        server = srv;
    ...
    private void sendButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendButtonActionPerformed
        ...
        {
            server.broadcastMessage(null,"Server : "+msg);
        }
